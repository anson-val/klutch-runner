...
class JVMExecutor(private val dockerWorkspace: String) : IExecutor {
    ...
    override fun execute(
        ...
        val inputFilePath = dockerWorkspace.appendPathUnix(ConfigLoader.config.runner.jvm.inputFilename)
        val outputFilePath = dockerWorkspace.appendPathUnix(ConfigLoader.config.runner.jvm.outputFilename)
